...
import { DynamicListTypes } from './DynamicList.props';
...
/**
 * DynamicList is generated by Webcodesk. Replace this comment with a valuable description.
 */
...
DynamicList.propTypes = DynamicListTypes;
...
DynamicList.defaultProps = {
  ...
  onInputTextChange: () => {
    console.info('DynamicList.onInputTextChange is not set');
  },
  onSubmit: () => {
    console.info('DynamicList.onSubmit is not set');
  }
};
